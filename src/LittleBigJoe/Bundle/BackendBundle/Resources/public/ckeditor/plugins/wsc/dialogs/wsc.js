...
(function () {
    ...
    a.OverlayPlace = null;
    a.LocalizationButton = {ChangeTo: {instance: null, text: "Change to"}, ChangeAll: {instance: null, text: "Change All"}, IgnoreWord: {instance: null, text: "Ignore word"}, IgnoreAllWords: {instance: null, text: "Ignore all words"}, Options: {instance: null, text: "Options", optionsDialog: {instance: null}}, AddWord: {instance: null, text: "Add word"}, FinishChecking: {instance: null, text: "Finish Checking"}};
    a.LocalizationLabel = {ChangeTo: {instance: null, text: "Change to"},
    ...
    a.buildSelectLang = function () {
        ...
        b.setStyles({height: "auto", position: "absolute", right: "0", top: "-1px", width: "160px", "white-space": "normal"});
        c.setAttribute("id", d);
    ...
    var l = function (a) {
        ...
        b.onchange = function () {
            ...
            f.postMessage.send({message: {changeLang: a.selectingLang, text: a.dataTemp}, target: a.targetFromFrame[d], id: "selectionLang_outer__page"})
        }
    }, v = function (b) {
        ...
        f.postMessage.send({message: b, target: a.targetFromFrame[a.iframeNumber + "_" + a.dialog._.currentTabId], id: "options_outer__page"})
        ...
        "false" == a.show_grammar && n();
        "undefined" == c && (a.userDictionaryName ? (c = a.userDictionaryName, d = {osp: f.cookie.get("osp"), udn: a.userDictionaryName, cust_dic_ids: a.cust_dic_ids, id: "options_dic_send", udnCmd: "create"}, f.postMessage.send({message: d, target: a.targetFromFrame[void 0]})) : c = "");
        f.cookie.set("osp",
            b.DefOptions.osp);
        f.cookie.set("udn", c);
        ...
        var b = {osp: f.cookie.get("osp"), udn: f.cookie.get("udn"), cust_dic_ids: a.cust_dic_ids, id: "options_dic_send", udnCmd: f.cookie.get("udnCmd")};
        ...
        d = d || a.dataTemp;
        f.postMessage.send({message: {customerId: a.wsc_customerId, text: d, txt_ctrl: a.TextAreaNumber, cmd: c, cust_dic_ids: a.cust_dic_ids, udn: a.userDictionaryName, slang: a.selectingLang, reset_suggest: e || !1}, target: b, id: "data_outer__page"});
        a.div_overlay.setEnable()
    }, p = {superset: function () {
    ...
    CKEDITOR.dialog.add("checkspell", function (b) {
        var c = function () {
            ...
            f.postMessage.send({message: {cmd: this.getElement().getAttribute("title-cmd"), tabId: c, new_word: e}, target: a.targetFromFrame[d], id: "cmd_outer__page"});
        ...
        return{title: b.config.wsc_dialogTitle || b.lang.wsc.title, minWidth: 560, minHeight: 444, buttons: [CKEDITOR.dialog.cancelButton],
            onShow: function () {
                a.dialog = this;
                ...
                CKEDITOR.scriptLoader.load(e, function (c) {
                    ...
                    a.div_overlay = new l({opacity: "1", background: "#fff url(" + a.loadIcon + ") no-repeat 50% 50%", target: a.OverlayPlace});
                    var d = CKEDITOR.document.getById("cke_dialog_tabs_" + (a.CKNumber + 1));
                    d.setStyle("width", "97%");
                    d.getElementsByTag("DIV").count() || d.append(a.buildSelectLang());
                    a.div_overlay_no_check = new l({opacity: "1", id: "no_check_over", background: "#fff url(" +
                ...
                {id: "SpellTab", label: "SpellChecker", accessKey: "S", elements: [
                    ...
                    {type: "hbox", id: "bottomGroup",
                        ...
                        {type: "hbox", id: "leftCol", align: "left", width: "50%", children: [
                            {type: "vbox", id: "rightCol1", widths: ["50%", "50%"], children: [
                                ...
                                {type: "hbox", id: "rightCol",
                                    align: "right", width: "30%", children: [
                        ...
                        {type: "hbox", id: "rightCol", align: "right", width: "50%", children: [
                            ...
                            {type: "vbox", id: "rightCol_col__right", widths: ["50%", "50%", "50%"], children: [
                                {type: "button", id: "IgnoreWord",
                                    label: a.LocalizationButton.IgnoreWord.text, title: "Ignore word", style: "width: 100%;", onLoad: function () {
                                    this.getElement().setAttribute("title-cmd", this.id);
                    ...
                    {type: "hbox", id: "BlockFinishChecking", style: "width:560px; margin: 0 auto;", widths: ["70%", "30%"], onShow: function () {
                        ...
                        {type: "hbox", id: "rightCol", align: "right", width: "30%", children: [
                            {type: "vbox", id: "rightCol_col__left", children: [
                                {type: "button", id: "Option_button",
                                    label: a.LocalizationButton.Options.text, title: "Option", style: "width: 100%;", onLoad: function () {
                                    this.getElement().setAttribute("title-cmd", this.id);
                                    "file:" == document.location.protocol && this.disable()
                                }, onClick: function () {
                                    "file:" == document.location.protocol ? alert("WSC: Options functionality is disabled when runing from file system") : b.openDialog("options")
                ...
                {id: "GrammTab", label: "Grammar", accessKey: "G", elements: [
                    ...
                    {type: "vbox", id: "bottomGroup", style: "width:560px; margin: 0 auto;", children: [
                        {type: "hbox", id: "leftCol", widths: ["66%", "34%"], children: [
                            {type: "vbox", children: [
                                {type: "text",
                                    id: "text", label: "Change to:", labelLayout: "horizontal", labelStyle: "font: 12px/25px arial, sans-serif;", inputStyle: "float: right; width: 200px;", "default": "", onShow: function () {
            ...
            {id: "OptionsTab", label: "Options", accessKey: "O", elements: [
                ...
                {type: "vbox", id: "Options_content", children: [
                    {type: "hbox", id: "Options_manager", widths: ["52%", "48%"], children: [
                        {type: "fieldset",
                            label: "Spell Checking Options", style: "border: none;margin-top: 13px;padding: 10px 0 10px 10px", onShow: function () {
                        ...
                        {type: "vbox", id: "Options_DictionaryName", children: [
                            {type: "text", id: "DictionaryName", style: "margin-bottom: 10px", label: "Dictionary Name:", labelLayout: "vertical",
                                labelStyle: "font: 12px/25px arial, sans-serif;", "default": "", onLoad: function () {
                                j = this;
