 ...
 * @ORM\Entity(repositoryClass="LittleBigJoe\Bundle\FrontendBundle\Repository\ProjectContributionRepository")
 */
class ProjectContribution
{
     ...
     * Set reward
     *
     * @param \LittleBigJoe\Bundle\FrontendBundle\Entity\ProjectReward $reward
     * @return ProjectContribution
     */
    public function setReward(\LittleBigJoe\Bundle\FrontendBundle\Entity\ProjectReward $reward = null)
    {
        $this->reward = $reward;
     ...
     * Get reward
     *
     * @return \LittleBigJoe\Bundle\FrontendBundle\Entity\ProjectReward
     */
