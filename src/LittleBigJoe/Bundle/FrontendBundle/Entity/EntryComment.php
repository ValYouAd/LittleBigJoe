 ...
 * @ORM\Entity(repositoryClass="LittleBigJoe\Bundle\FrontendBundle\Repository\EntryCommentRepository")
 */
class EntryComment
{
    /**
     ...
     *    message = "Your comment content must only contains numbers, letters, spaces, dots, commas, exclamation marks or dashes"
     * )
     */
    private $content;
     ...
     * Set entry
     *
     * @param \LittleBigJoe\Bundle\FrontendBundle\Entity\Entry $entry
     * @return EntryComment
     */
    public function setEntry(\LittleBigJoe\Bundle\FrontendBundle\Entity\Entry $entry = null)
    {
        $this->entry = $entry;
     ...
     * Get entry
     *
     * @return \LittleBigJoe\Bundle\FrontendBundle\Entity\Entry
     */
