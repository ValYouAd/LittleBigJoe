 ...
 * @ORM\Table(name="page")
 * @UniqueEntity("slug")
 * @ORM\Entity(repositoryClass="LittleBigJoe\Bundle\FrontendBundle\Repository\PageRepository")
 * @Gedmo\TranslationEntity(class="LittleBigJoe\Bundle\FrontendBundle\Entity\PageTranslation")
 */
class Page
{
    /**
     ...
     * @Assert\Regex(
     *    pattern = "/^[ÀÁÅÃÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõöøùúûüýþÿa-zA-Z\-]*$/",
     *    message = "Your META page description must only contains letters, or dashes"
     * )
     */
     ...
     * Add translations
     *
     * @param \LittleBigJoe\Bundle\FrontendBundle\Entity\PageTranslation $translations
     * @return Page
     */
    public function addTranslation(\LittleBigJoe\Bundle\FrontendBundle\Entity\PageTranslation $t)
    {
     ...
     * @param \LittleBigJoe\Bundle\FrontendBundle\Entity\PageTranslation $translations
     */
    public function removeTranslation(\LittleBigJoe\Bundle\FrontendBundle\Entity\PageTranslation $translations)
    {
