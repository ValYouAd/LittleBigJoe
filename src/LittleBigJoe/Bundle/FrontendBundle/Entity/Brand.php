 ...
 * @UniqueEntity("slug")
 * @ORM\Entity(repositoryClass="LittleBigJoe\Bundle\FrontendBundle\Repository\BrandRepository")
...
class Brand
{
     ...
     *
     * @Assert\NotBlank(message = "You must enter your contact name")
     * @Assert\Length(
     *    min = "2",
     *    max = "250",
     ...
     * @var string
     *
     * @ORM\Column(name="contact_status", type="string", length=255)
     *
     * @Assert\NotBlank(message = "You must enter your contact status")
     * @Assert\Length(
     *    min = "2",
     *    max = "250",
     ...
     * @var string
     *
     * @ORM\Column(name="contact_phone", type="string", length=15)
     *
     * @Assert\NotBlank(message = "You must enter your contact phone")
     * @Assert\Regex(
     *    pattern = "/^[0-9\.\,]*$/",
     ...
     *
     * @Assert\NotBlank(message = "You must enter your contact email")
     * @Assert\Email(
