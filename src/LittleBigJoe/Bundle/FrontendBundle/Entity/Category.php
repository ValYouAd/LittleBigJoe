 ...
 * @UniqueEntity("slug")
 * @ORM\Entity(repositoryClass="LittleBigJoe\Bundle\FrontendBundle\Repository\CategoryRepository")
 * @Gedmo\TranslationEntity(class="LittleBigJoe\Bundle\FrontendBundle\Entity\CategoryTranslation")
 */
class Category
{
    /**
     ...
     * @Assert\Regex(
     *    pattern = "/^[ÀÁÅÃÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõöøùúûüýþÿa-zA-Z\-]*$/",
     *    message = "Your META category description must only contains letters, or dashes"
     * )
     */
    ...
    /**
     * @ORM\OneToMany(
     *     targetEntity="LittleBigJoe\Bundle\FrontendBundle\Entity\CategoryTranslation",
     *  mappedBy="object",
     ...
     * Add translations
     *
     * @param \LittleBigJoe\Bundle\FrontendBundle\Entity\CategoryTranslation $translations
     * @return Category
     */
    public function addTranslation(\LittleBigJoe\Bundle\FrontendBundle\Entity\CategoryTranslation $t)
    {
     ...
     * @param \LittleBigJoe\Bundle\FrontendBundle\Entity\CategoryTranslation $translations
     */
    public function removeTranslation(\LittleBigJoe\Bundle\FrontendBundle\Entity\CategoryTranslation $translations)
    {
