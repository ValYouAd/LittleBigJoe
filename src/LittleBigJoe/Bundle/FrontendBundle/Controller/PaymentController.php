    ...
    public function processAction(Request $request)
    {
        ...
        if (!empty($mangopayContribution)) {
            if (!empty($mangopayContribution->ID)) {
                ...
                $this->get('session')->remove('validatedContribution');
    ...
    public function confirmationAction(Request $request)
    {
        ...
        if ($this->get('session')->get('contributionId') != null) {
            ...
            if (!empty($mangopayContribution) && !empty($contribution)) {
                ...
                if ($mangopayContribution->IsSucceeded == true && $mangopayContribution->IsCompleted == true && !$this->get('session')->has('validatedContribution')) {
                    $status = 'OK';
                    $this->get('session')->set('validatedContribution', true);
